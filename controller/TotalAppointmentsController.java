...
/**This class is the controller for the view-total-appointments page. */
public class TotalAppointmentsController implements Initializable {
    ...
    /**This is the initialize method. This fills the page with the appointments report. Separating
      them by year, month, and type. */
    @Override
    public void initialize(URL url, ResourceBundle rb) {
        ...
        stringBuilder.append("        Appointments Report- Sorted by YEAR-MONTH-TYPE" + "\n" + "\n");
